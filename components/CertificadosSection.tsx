...
export default function CertificadosSection() {
  return (
    <section className="h-238.25 flex items-center justify-center">
      <div className="flex items-center justify-center flex-col bg-opacity-50 p-6 rounded-lg">
        <h2 className="text-6xl flex text-center leading-18  font-semibold text-black  font-syncopate">
          The Santosha <br /> Yoga Space{" "}
        </h2>
        <p
          className="text-black text-3xl mt-12 mb-4 text-black-600 line-height-6"
          style={{ padding: "0 297px", textAlign: "center" }}
        >
